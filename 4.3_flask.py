# EXERCICIO 4-3: Validação básica de campos
# Implemente uma verificação no formulário anterior para garantir que os valores sejam números antes de somá-los.
